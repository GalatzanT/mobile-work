...
const itemUrl = `http://${baseUrl}/masini`;
...
export const getItems: () => Promise<MasinaProps[]> = () => {
  return withLogs(axios.get(itemUrl, config), "getItems");
};

export const createItem: (item: MasinaProps) => Promise<MasinaProps[]> = (
  item
) => {
  return withLogs(axios.post(itemUrl, item, config), "createItem");
};

export const updateItem: (item: MasinaProps) => Promise<MasinaProps[]> = (
  item
) => {
  return withLogs(
